...
(function() {
  $(function() {
    var available_tags, typeahead_engine;
    window.autosaves = {};
    ...
    $('[data-tokens]').tokenfield({
      typeahead: [
        null, {
          source: typeahead_engine.ttAdapter()
        }
      ],
      delimeter: ","
      ...
      return $($target.closest('form')).trigger('submit.rails');
    });
    return $('[data-autosave]').on('change paste keyup', function(e) {
      var timer;
      timer = window.autosaves[e.target.id];
      if (timer != null) {
        clearTimeout(timer);
      }
      return window.autosaves[e.target.id] = setTimeout((function() {
        var $target;
        $target = $(e.target);
        return $($target.closest('form')).trigger('submit.rails');
      }), 1000);
