class ClipsController < ApplicationController
  ...
  private
    ...
    def clip_params
      params.require(:clip).permit(:name, :address, :latitude, :longitude, :uri, :remote_image_url, :image, :scheduled_at, :date_list, :day_list, :type_list, comment_attributes: [:comment, :private_comment])
    end
