class ClipsController < ApplicationController
  ...
  def copy
    ...
    last_clip(copy)
    heap_event('Clip Copied', copied_clip: clip.id, copied_to_trip: trip_id.to_i)
  ...
  private
    ...
    def clip_params
      params.require(:clip).permit(:name, :address, :latitude, :longitude, :uri, :remote_image_url, :image, :scheduled_at, :date_list, :day_list, :type_list, public_comment_attributes: [:comment], private_comment_attributes: [:comment])
    end
