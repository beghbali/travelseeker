...
$ ->
  ...
  initDateRangePicker= ->
    $('.bootstrap_form-datetimepicker').datetimepicker({sideBySide: false, allowInputToggle: true, keepOpen: false, format: "YYYY-MM-DD HH:mm Z", useCurrent: false, inline: true});
